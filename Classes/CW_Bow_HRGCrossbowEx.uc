class CW_Bow_HRGCrossbowEx extends KFWeap_ScopedBase;

simulated event SetWeapon()
{
	super.SetWeapon();
	class'Utils'.static.ApplyCustomSkin(self, class'KFGameContent.KFWeap_Bow_Crossbow');
}
...
DefaultProperties
{
	...
	WeaponProjectiles(DEFAULT_FIREMODE)=class'Custom_KFProj_Bolt_CrossbowEx'
	InstantHitDamage(DEFAULT_FIREMODE)= 350 //420 //default = 350
	InstantHitDamageTypes(DEFAULT_FIREMODE)=class'Custom_KFDT_Piercing_CrossbowEx'
	...
	WeaponProjectiles(ALTFIRE_FIREMODE)=class'Custom_KFProj_HealBolt_CrossbowEx'
	FireInterval(ALTFIRE_FIREMODE)=+0.175
	InstantHitDamage(ALTFIRE_FIREMODE)=50
	InstantHitDamageTypes(ALTFIRE_FIREMODE)=class'Custom_KFDT_Piercing_Healing_CrossbowEx'
