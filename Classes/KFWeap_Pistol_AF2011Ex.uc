//=============================================================================
// KFWeap_Pistol_AF2011Ex
//=============================================================================
// ปืนพก AF2011 สองลำกล้องเดี่ยว เวอร์ชันดัดแปลง
// - แก้บั๊กกระสุนเลขคี่ตอน equip
// - บังคับยิงสองลำกล้องพร้อมกันทุกนัด
// - นับ shots fired ให้ถูกต้องสำหรับ perk (นับเป็น 2 ต่อการยิง)
// - ปรับ recoil ให้รุนแรงขึ้น
//=============================================================================

class KFWeap_Pistol_AF2011Ex extends KFWeap_Pistol_AF2011;

// SetWeapon — ถูกเรียกเมื่ออาวุธถูก equip เข้าไปในช่อง
//   ตั้งเวลา 0.3 วินาที เพื่อตรวจสอบกระสุนเลขคี่
// พารามิเตอร์: ไม่มี
// คืนค่า: ไม่มี
// แก้บั๊กกระสุนเลขคี่ตอน equip
...
//   ถ้าจำนวนกระสุนในช่องใดช่องหนึ่งเป็นเลขคี่ จะลดลง 1 เพื่อให้เป็นเลขคู่
//   เนื่องจากปืนยิง 2 นัดต่อการกดไก กระสุนต้องเป็นเลขคู่เสมอ
// พารามิเตอร์: ไม่มี
// คืนค่า: ไม่มี
...
//   สำหรับ AF2011 ที่ยิง 2 ลำกล้องพร้อมกัน ต้องนับเป็น 2 นัด
// พารามิเตอร์:
...
//   เรียก super ของ KFWeap_PistolBase สองครั้ง เพื่อให้สองลำกล้องยิงพร้อมกัน
// พารามิเตอร์: ไม่มี
// คืนค่า: ไม่มี
...
//    InstantHitDamageTypes(DEFAULT_FIREMODE)=class'KFDT_Ballistic_AF2011Ex'
    ...
    // WeaponDef ชี้ไปที่ของใหม่
    WeaponSelectTexture=Texture2D'WEP_UI_AF2001_TEX.UI_WeaponSelect_AF2011'

    // Dual class ชี้ไปที่ของใหม่
    DualClass=class'KFWeap_Pistol_DualAF2011Ex'
