...
class CW_Rifle_M14EBR_RS extends KFWeap_Rifle_M14EBR;
...
function SetOriginalValuesFromPickup(KFWeapon PickedUpWeapon)
{
	...
	SetLaserSightEnabled(CW_Rifle_M14EBR_RS(PickedUpWeapon).bIsLaserSightEnabled);
	ClientSetLaserSight(bIsLaserSightEnabled);
}

DefaultProperties
{
	InstantHitDamageTypes(DEFAULT_FIREMODE)=class'CWP.KFDT_Ballistic_M14EBR_RS'
